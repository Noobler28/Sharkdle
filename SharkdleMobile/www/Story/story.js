...
const STORY_IMAGE_SHARKS_PER_CHAPTER = 3;
...
const areaDefinitions = [
        {
            ...
            left: 36,
            top: 48,
        sharks: ["Blue Shark", "Short-fin Mako", "Common Thresher Shark"],
        speciesDescriptions: {
            "Blue Shark": "Follow an open-ocean wanderer through North Atlantic current lines and long-range tag returns.",
            "Short-fin Mako": "Audit the speed records of a warm-bodied hunter built for fast offshore chases.",
            "Common Thresher Shark": "Verify tail-strike reports from shelf edges where schooling fish vanish in a flash."
        },
        nonSharks: [
            "Epaulette Shark",
            "Port Jackson Shark",
        ...
        narrative: "Atlantic receivers are drowning in bad data: blue shark tracks loop through impossible gyres, mako speed bursts are stamped onto slow drifters, and thresher tail-strikes are filed as wave noise. Rebuild the offshore record before the first breach spreads across the map.",
        completionNarrative: "Dr. Finn's secure line crackles back: 'Clean work, {playerUsername}. The Atlantic no longer has duplicate tags, but the Pacific has started shedding whole migration paths. Get across the map before that current carries the corruption farther.'",
        facts: [
            ...
            "Short-fin Makos can keep parts of their bodies warmer than the surrounding water, helping power fast offshore hunts.",
            "Blue Sharks often roam far from shore and are strongly associated with pelagic Atlantic waters.",
            "Common Threshers use the upper lobe of the tail like a whip when hunting tight schools of fish."
        ],
        falseFacts: [
            ...
            "Short-fin Makos are known for unusually slow swimming speeds, often drifting helplessly with currents.",
            "The Blue Shark can survive in both freshwater and saltwater environments.",
            "Common Thresher Sharks are reef grazers that feed mainly on seagrass."
        ],
        challenges: [
            { name: "Species Identification", desc: "Pick the three open-Atlantic species from corrupted offshore logs." },
            { name: "Image Mix Up", desc: "Match each Atlantic dossier image to the right species record." },
            { name: "Region Report", desc: "Separate real Atlantic field notes from planted false telemetry." }
        ],
        bossMission: {
            title: "The Atlantic Signal",
            desc: "Trace the first corrupted ping through the shipping lanes and lock the offshore archive.",
            story: "Dr. Finn thinks the original breach rode in on an Atlantic survey grid. The boss mission sends you through the last clean current line, where every restored species record helps pin the signal before it can split again."
        }
    },
    {
    id: "pacific",
    ...
    left: 13,
    top: 52,
    sharks: ["Tiger Shark", "Oceanic Whitetip Shark", "Salmon Shark"],
    speciesDescriptions: {
        "Tiger Shark": "Track a broad-ranging predator through warm Pacific islands, reefs, and coastal patrol zones.",
        "Oceanic Whitetip Shark": "Restore open-water records for a pelagic cruiser built for vast blue-water distances.",
        "Salmon Shark": "Chase cold North Pacific telemetry from a compact lamnid that hunts in chilly current systems."
    },
    nonSharks: [
    ...
    narrative: "The Pacific hub is fragmenting into three incompatible maps: tiger shark tracks sprawl across island chains, oceanic whitetip reports vanish into empty blue water, and salmon shark tags flicker in cold northern feeds. Stabilize the region before the largest ocean turns into static.",
    completionNarrative: "A secure ping hits your console. Dr. Finn again: 'Excellent work, {playerUsername}. The Pacific records are back online, but something is wrong in the Indian Ocean. The corruption is accelerating. Get there immediately.'",
    facts: [
    ...
    falseFacts: [
        ...
        "Tiger Sharks are tiny deep-sea lantern sharks that glow to attract plankton.",
        "Salmon Sharks cannot tolerate cold water and avoid the North Pacific."
    ],
    challenges: [
        { name: "Species Identification", desc: "Recover the three Pacific species from scrambled ocean-basin reports." },
        { name: "Image Mix Up", desc: "Pair each Pacific image with the corrected archive name." },
        { name: "Region Report", desc: "Flag the Pacific reports that do not match real species behavior." }
    ],
    bossMission: {
        title: "The Pacific Undertow",
        desc: "Drop into the central current and anchor the drifting Pacific records.",
        story: "The Pacific does not just hold the corruption. It carries it. Dr. Finn says the last fragment is riding a current that turns every mistake into a new route. Stop it here or every future chapter inherits the damage."
    }
    },
    {
        id: "indian",
        ...
        left: 64,
        top: 65,
        sharks: ["Bull Shark", "Zebra Shark", "Whitetip Reef Shark"],
        speciesDescriptions: {
            "Bull Shark": "Trace a salinity-tolerant predator through coasts, estuaries, and river-linked Indian Ocean records.",
            "Zebra Shark": "Restore reef-floor sightings of a patterned carpet shark whose juveniles and adults look strikingly different.",
            "Whitetip Reef Shark": "Verify night patrol data from reef ledges where this site-faithful hunter returns again and again."
        },
        nonSharks: [
            "Atlantic Sharpnose Shark",
            "Caribbean Reef Shark",
        ...
        narrative: "The Indian Ocean archive is collapsing along reef edges and river mouths. Bull shark salinity logs are mixed with reef sightings, zebra shark nursery notes are mislabeled, and whitetip reef patrol routes keep resetting to zero. Rebuild the chapter before the monsoon data overwrites itself.",
        ...
        facts: [
            ...
            "Young Zebra Sharks have bold stripes, while adults develop spot patterns.",
        ...
        falseFacts: [
            ...
            "Zebra Sharks keep the same stripe pattern from birth through adulthood.",
            "Whitetip Reef Sharks are giant open-ocean filter feeders."
        ],
            challenges: [
        ...
        bossMission: {
            ...
            desc: "Seal the reef and estuary records before the storm cycle rewrites them.",
    ...
    },
    {
        ...
        left: 54,
        top: 41,
        sharks: ["Angel Shark", "Small-tooth Sandtiger Shark", "Basking Shark"],
        speciesDescriptions: {
            "Angel Shark": "Recover sand-flat ambush records from one of the Mediterranean's most threatened shark lineages.",
            "Small-tooth Sandtiger Shark": "Check rare deep-slope sightings where this elusive lamniform slips through historical logs.",
            "Basking Shark": "Track seasonal filter-feeding reports from a giant that turns plankton blooms into migration clues."
        },
        nonSharks: [
            "Epaulette Shark",
            "Port Jackson Shark",
        ...
        falseFacts: [
            ...
            "Angel Sharks are fast open-ocean filter feeders that never touch the seafloor.",
            "Small-tooth Sandtiger Sharks are freshwater river specialists.",
            "Basking Sharks use serrated teeth to tear apart large marine mammals.",
            "Angel Sharks glow with bioluminescent stripes to lure prey."
        ],
            challenges: [
                { name: "Species Identification", desc: "Find the three Mediterranean species hidden in the historical archive." },
                { name: "Image Mix Up", desc: "Link each Mediterranean image to the corrected species name." },
                { name: "Region Report", desc: "Tell real Mediterranean field notes from corrupted legends." }
            ],
        bossMission: {
            title: "The Crossroads Archive",
            desc: "Restore the sea where old records, rare sightings, and live telemetry collide.",
    ...
    },
    {
        ...
        left: 85,
        top: 80,
        sharks: ["Spotted Wobbegong", "Port Jackson Shark", "Epaulette Shark"],
        speciesDescriptions: {
            "Spotted Wobbegong": "Search reef-bottom imagery for a carpet shark whose camouflage turns rock into ambush cover.",
            "Port Jackson Shark": "Rebuild rocky-reef records around a bullhead shark known for spiral egg cases.",
            "Epaulette Shark": "Verify tide-pool reports from a small shark famous for walking over reef flats."
        },
        nonSharks: [
            "Atlantic Sharpnose Shark",
            "Caribbean Reef Shark",
        ...
        narrative: "Australian reef nodes are reporting impossible pairings: desert sharks in coral lagoons, polar threshers on reef flats, and deep-sea species in ankle-deep tide pools. Wobbegong camouflage logs, Port Jackson egg-case records, and epaulette walking reports need a clean rebuild.",
        completionNarrative: "Australian archives re-sync. Dr. Finn checks the map: 'The reef data is back, {playerUsername}. But South African stations are screaming errors. Head to the Cape sector. The corruption is circling the globe.'",
        facts: [
        ...
        falseFacts: [
            ...
            "Port Jackson Sharks use long tail whips to stun sardine schools.",
            "Spotted Wobbegongs migrate to Arctic pack ice every winter."
        ],
        challenges: [
            { name: "Species Identification", desc: "Choose the three Australian species from reef-flat records." },
            { name: "Image Mix Up", desc: "Match the Australian dossier images to their species." },
            { name: "Region Report", desc: "Sort real Australian reef notes from impossible sightings." }
        ],
        bossMission: {
            title: "The Reef Lantern",
            desc: "Relight the reef corridor and expose the false shallow-water telemetry.",
    ...
    },
    {
        ...
        left: 55,
        top: 76,
        sharks: ["White Shark", "Copper Shark", "Leopard Catshark"],
        speciesDescriptions: {
            "White Shark": "Pin down seal-colony patrol records for the Cape's most famous large coastal predator.",
            "Copper Shark": "Track bronze whaler aggregations through temperate water where currents meet.",
            "Leopard Catshark": "Recover nocturnal kelp and reef records for a small spotted shark native to southern Africa."
        },
        nonSharks: [
            "Port Jackson Shark",
            "Japanese Bullhead Shark",
        ...
        narrative: "Cape tracking stations are merging two oceans into one bad file. White shark patrols are duplicated into the Atlantic chapter, copper shark schools are labeled as reef debris, and leopard catshark night records are disappearing in kelp shadows. Untangle the Cape before the current carries the error west.",
        completionNarrative: "South African telemetry clears. Dr. Finn answers quickly: 'Cape records secured, {playerUsername}. The corruption just resurfaced on the US East Coast with the same signature as the first Atlantic breach. Finish the loop back where this started.'",
        facts: [
            ...
            "White Sharks can use regional seal colonies as important hunting grounds.",
            "Copper Sharks occur in temperate coastal waters of southern Africa."
        ],
        falseFacts: [
            ...
            "Copper Sharks are deep-sea lantern sharks that produce blue light.",
            "Leopard Catsharks are filter-feeding giants found only in polar seas."
        ],
        challenges: [
            { name: "Species Identification", desc: "Identify the three Cape species without duplicating the Atlantic lineup." },
            { name: "Image Mix Up", desc: "Match South African images to their cleaned species records." },
            { name: "Region Report", desc: "Sort real Cape field notes from cross-ocean data leaks." }
        ],
        bossMission: {
            title: "Cape of Currents",
            desc: "Close the loop where Atlantic and Indian records keep bleeding together.",
    ...
    },
    {
        ...
        left: 28,
        top: 38,
        sharks: ["Sand Tiger Shark", "Dusky Shark", "Bonnethead Shark"],
        speciesDescriptions: {
            "Sand Tiger Shark": "Restore wreck and inlet reports for a slow-cruising shark often seen along the East Coast.",
            "Dusky Shark": "Check long-distance coastal migration data from a large shark with heavy seasonal movement.",
            "Bonnethead Shark": "Recover shallow seagrass records for the smallest hammerhead species."
        },
        nonSharks: [
            "Port Jackson Shark",
            "Japanese Bullhead Shark",
        ...
        narrative: "The corruption has come full circle. East Coast receivers are replaying the first Atlantic glitch, now amplified into wreck sightings, inverted coastal migrations, and ghost records in Chesapeake and Carolinian feeds. Rebuild the USA East Coast archive without borrowing any earlier chapter species.",
        completionNarrative: "East Coast data stabilizes. Dr. Finn lowers his voice: 'Almost there, {playerUsername}. One last hotspot remains: Japan. Ancient species records and deep trench nodes are still corrupt. Finish this in the Pacific Rim sector.'",
        facts: [
        ...
        falseFacts: [
            ...
            "Sand Tiger Sharks are plankton-filtering giants larger than whale sharks.",
            "Dusky Sharks live only in Arctic pack ice and never approach coasts.",
            "Bonnethead Sharks are deep-sea sharks with glowing photophores."
        ],
        challenges: [
            { name: "Species Identification", desc: "Identify the three East Coast species from coastal receiver logs." },
            { name: "Image Mix Up", desc: "Match each East Coast image to the correct dossier." },
            { name: "Region Report", desc: "Separate true East Coast reports from the returning Atlantic glitch." }
        ],
        bossMission: {
            title: "The Return Current",
            desc: "Follow the returning current and expose the source of the first breach.",
    ...
    },
    {
        ...
        left: 87,
        top: 36,
        sharks: ["Japanese Bullhead Shark", "Frilled Shark", "Megamouth Shark"],
        speciesDescriptions: {
            "Japanese Bullhead Shark": "Recover rocky-bottom records for a small horn shark tied closely to Japanese coastal waters.",
            "Frilled Shark": "Descend into deep-water logs for an eel-like species that feels pulled from an older ocean.",
            "Megamouth Shark": "Restore rare filter-feeder sightings from one of the strangest large sharks in the archive."
        },
        nonSharks: [
            "Atlantic Sharpnose Shark",
            "Caribbean Reef Shark",
        ...
        narrative: "The final corrupted node sits beneath the Pacific Ring of Fire, where coastal horn-shark records, deep frilled shark telemetry, and rare megamouth sightings all fold into one ancient archive. Dr. Finn says this is the root cluster. Restore Japan's records and the global map can finally lock.",
        completionNarrative: "Every map sector flashes green. Dr. Finn laughs, exhausted: 'You did it, {playerUsername}. The global shark database is whole again. Take a break, you earned it. The oceans are back online because of you.'",
        facts: [
            ...
            "Frilled Sharks have multiple pairs of gill slits and an eel-like body shape.",
            "Megamouth Sharks are known from relatively few encounters compared with many coastal sharks."
        ],
        falseFacts: [
            ...
            "Megamouth Sharks are small reef grazers that feed on coral polyps.",
            "Japanese Bullhead Sharks are filter feeders that strain plankton in the open ocean."
        ],
        challenges: [
            { name: "Species Identification", desc: "Identify the three final Japanese species from coastal and deep-water logs." },
            { name: "Image Mix Up", desc: "Match the final chapter images to their restored archive names." },
            { name: "Region Report", desc: "Sort true Japanese field notes from root-cluster fabrications." }
        ],
        bossMission: {
            title: "The Ancient Deep",
            desc: "Descend into the root archive and restore the last ancient record.",
...
const SHARK_VISUAL_PROFILES = {
    ...
    "Bonnethead Shark": [
        "a small hammerhead with a rounded shovel-shaped head",
        "a compact body with a gentle bonnet-shaped cephalofoil",
        "a little hammerhead profile moving low over the grass beds"
    ],
    "Spinner Shark": [
...
function getStorySpeciesDescription(area, speciesName) {
    return area?.speciesDescriptions?.[speciesName]
        || "Open this dossier to verify sightings, match field images, and restore the regional record.";
}
...
async function openAreaModal(areaId) {
    ...
    speciesLineup.forEach((species, speciesIndex) => {
        ...
        card.innerHTML = `
            ...
            <div class="story-species-desc">${getStorySpeciesDescription(area, species.name)}</div>
        `;
